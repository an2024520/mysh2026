...
# ============================================================
#  Sing-box 节点新增: AnyTLS + Reality (v3.0 Final)
#  - 核心: 自动识别路径 + 写入 Inbounds + 保存公钥到 .meta
#  - 协议: AnyTLS (Sing-box 专属拟态协议)
#  - 基础: 基于 v2.5 原版修改 (保留端口霸占清理/连通性检查)
# ============================================================
...
# === 步骤 4: 写入伴生元数据 (关键步骤: 保存公钥) ===
# 逻辑：读取旧文件 -> 合并新 Key -> 写入临时文件 -> 覆盖原文件
